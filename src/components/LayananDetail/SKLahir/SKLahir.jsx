        ...
        <div className="mb-4 d-flex justify-content-between">
          <div>
            <h5 className="mb-1 text-heading-5 text-grey-1">
              Pengajuan Surat Keterangan Surat Lahir
            </h5>
              ...
              <div className="row">
                <div className="col-12 col-md-6">
                  <div className="mb-3">
                    ...
                    <input type="file" className="form-control" id="kk-ortu" />
                  </div>
                </div>
                <div className="col-12 col-md-6">
                  <div className="mb-3">
                    ...
                    <input type="file" className="form-control" id="ktp-ortu" />
                  </div>
                </div>
                <div className="col-12 col-md-6">
                  <div className="mb-3">
