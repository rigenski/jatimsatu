  ...
  const handleCreateSosialForm = async (data) => {
    ...
    if (KK) {
      ...
      const storageRef = ref(
        storage,
        `documents/sosial/bantuan-bencana/${KKSelected.name}`
      );
    ...
    if (KTP) {
      ...
      const storageRef = ref(
        storage,
        `documents/sosial/bantuan-bencana/${KTPSelected.name}`
      );
    ...
    if (suratRekomendasiRTRW) {
      ...
      const storageRef = ref(
        storage,
        `documents/sosial/bantuan-bencana/${suratRekomendasiRTRWSelected.name}`
      );
    ...
    const dataJSON = {
      formTypeId: "a68bc1f0-bba6-4b26-b266-e97d96352c0e",
